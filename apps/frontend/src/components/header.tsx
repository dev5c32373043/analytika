...
import { logout } from '../app/customer.slice';
...
export function Header() {
  ...
  return (
    <header className="border-b-1 relative z-20 w-full border-b border-slate-200 bg-gray-800 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
          ...
          >
            {location.pathname === '/api-settings' && (
              <li role="none" className="flex items-stretch">
                <Link
                  className="flex items-center gap-2 py-4 text-slate-200 transition-colors duration-300 hover:text-emerald-600 lg:px-8"
                  to="/"
                >
                  <span>Home</span>
                </Link>
            ...
            <li role="none" className="flex items-stretch">
              <button
                ...
                disabled={customer.loading !== 'idle'}
              >
                <span>Logout</span>
              </button>
            </li>
